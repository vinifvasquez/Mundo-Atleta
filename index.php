						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-md-3">Preço em <?php echo CURRENCY; ?></div>
								</div>
							</div>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<p><br/></p>
									<!--<a href="#" style="color:white; list-style:none;">Esqueceu senha</a><input type="submit" class="btn btn-success" style="float:right;">
                                           -->
								</form>
								</div>
		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					...
					<div class="panel-footer">&copy; Mundo Atleta, São José dos Campos. 2023</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
